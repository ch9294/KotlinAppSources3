package kr.co.softcampus.capturevideo
...
class MainActivity : AppCompatActivity() {
    ...
    fun init(){
        ...
        button.setOnClickListener { view ->
            ...
            var fileName = "temp_${System.currentTimeMillis()}.mp4"
            var picPath = "${dirPath}/${fileName}"

            var file = File(picPath)

            if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.N){
                contentUri = FileProvider.getUriForFile(this, "kr.co.softcampus.capturevideo.file_provider", file)
            } else {
